...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "D:\\JavaProject\\weexpro\\src\\bank\\customerlist.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-b8c22452"
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        complete: function complete(data) {
	            cmObj.log("complete-> ");
	            //隐藏加载旋转菊花
	            this.$refs.prorefresh.hideIndicator();
	            ...
	            if (data.Success == 1) {
	                ...
	                self.reHeight = self.lists.length * 200;
	            } else {
	                mdMsg.showToast(data.Msg);
	            }
	            cmObj.log('network complete');
	        },
	        sendRequest: function sendRequest() {
	            //发送数据请求
	            var body = {};
	            body.VersionId = "218d0b22-4e9b-47c1-8d20-1aaa68451ef1";
	            body.LoanApplyId = "8fbd8896-b620-41ca-9640-00f3c193e07d";
	            body.PageIndex = page;
	            body.PageSize = 10;
	            body.SearchContent = "";
	            body.Status = 0;

	            ntObj.postData(cmObj.GetApplyByAccountManagerId, body, self.complete, null);
	        },
	        selectItem: function selectItem(event) {
	            cmObj.log('selectItem openURL');
	            cmObj.openURL("../loanapplication.js");
	        }
	    }
	};
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, _vm._l((_vm.lists), function(value) {
	    return _c('div', {
	      staticClass: ["cell"]
	    }, [_c('div', {
	      staticClass: ["panel"],
	      ...
	      staticClass: ["text"]
	    }, [_vm._v(_vm._s(value.CompanyName))])])])
	  }))], 1)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
