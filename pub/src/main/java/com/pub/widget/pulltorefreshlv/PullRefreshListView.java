package com.pub.widget.pulltorefreshlv;
...
public class PullRefreshListView extends SwipeRefreshLayout
    ...
    private void init(final Context context) {
        ...
        if (mSetEmptyEnable) {
            ...
            imgEmpty = (ImageView) emptyView.findViewById(R.id.img_empty);
            tvEmpty = (TextView) emptyView.findViewById(R.id.text_empty);
     ...
     * @param res
     */
    public void setImageEmpty(int res, String msg) {
        if (null != imgEmpty) {
            imgEmpty.setImageResource(res);
     ...
     * 设置空数据时的提示图片
     */
    public void setImageEmptyLoading(String msg) {
