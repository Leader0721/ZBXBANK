...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "D:\\JavaProject\\weexpro\\src\\loanapplication.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-394a3fdb"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var mdMsg = __webpack_require__(79);
	var storage = __webpack_require__(100);
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        //发送数据请求
	        var body = {};
	        body.VersionId = "79fa0577-7a7e-4e2e-a16c-bde47f85512e";
	        body.LoanApplyId = "31899c83-7bcf-4c3a-b6b8-a47d5c4648b3";
	        body.Step = 4;
	        body.Flag = 1;
	        ntObj.postData(cmObj.getApplication, body, self.complete, self.progress);

	        //存储测试
	        cmObj.log("this is save storage");
	        storage.setItem("success", "succeed", null);
	        storage.setItem("fail", "failed", null);
	    },
	    methods: {
	        backClick: function backClick(event) {
	            cmObj.pop();
	        },
	        complete: function complete(data) {
	            if (data.Success == 1) {
	                cmObj.matchKeyValue(self, data.Data);
	            } else {
	                mdMsg.showToast(data.Msg);
	            }

	            //测试存储
	            storage.getItem("success", function (event) {
	                cmObj.log("this is get storage");
	                if (event.result == "success") {
	                    cmObj.log(event.data);
	                } else {
	                    cmObj.log("call event is error");
	                }
	            });

	            storage.removeItem("success", function (event) {
	                cmObj.log("this is remove storage");
	                if (event.result == "success") {
	                    cmObj.log(event.data);
	                } else {
	                    cmObj.log("call event is error");
	            ...
	            storage.getAllKeys(function (event) {
	                cmObj.log("this is get all storage");
	                if (event.result == "success") {
	                    cmObj.log(event.data);
	                } else {
	                    cmObj.log("call event is error");
	        ...
	        progress: function progress(res) {
	            cmObj.log("progress value is" + res);
	        }
	    }
	};
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["baseInfoTitle"]
	  }, [_c('text', {
	    staticClass: ["titleText"]
	  }, [_vm._v(_vm._s(_vm.borrowerInfo))])]), _c('div', {
	    staticClass: ["itemInfo"]
	  }, [_vm._m(0), _c('div', {
	    staticClass: ["rightNormal"]
	  }, [_c('input', {
	    staticClass: ["inputNormal"],
	    attrs: {
	      "type": "text",
	      "value": _vm.FullName
	    }
	    ...
	    attrs: {
	      "type": "text",
	      "value": _vm.ContactsTel
	    }
	  })])]), _c('div', {
	    staticClass: ["baseInfoTitle"]
	  }, [_c('text', {
	    staticClass: ["titleText"]
	  }, [_vm._v(_vm._s(_vm.projectInfo))])]), _c('div', {
	    staticClass: ["itemInfo"]
	  }, [_vm._m(7), _c('div', {
	    staticClass: ["rightNormal"]
	  }, [_c('input', {
	    ...
	    attrs: {
	      "type": "text",
	      "value": _vm.ProjectSummary
	    }
	  })])]), _c('div', {
	    staticClass: ["baseInfoTitle"]
	  }, [_c('text', {
	    staticClass: ["titleText"]
	  }, [_vm._v(_vm._s(_vm.loanInfo))])]), _c('div', {
	    staticClass: ["itemInfo"]
	  }, [_vm._m(9), _c('div', {
	    staticClass: ["rightNormal"]
	  }, [_c('input', {
	    ...
	    staticClass: ["titleText"]
	  }, [_vm._v(_vm._s(_vm.bondsmanInfo))])]), _c('div', {
	    staticClass: ["itemInfo"]
	  }, [_vm._m(13), _c('div', {
	    staticClass: ["rightNormal"]
	  }, [_c('input', {
	  ...
	  return _c('div', {
	    staticClass: ["leftNormal"]
	  }, [_c('text', {
	    staticClass: ["titleNormal"]
	  }, [_vm._v("借款申请人全称")])])
