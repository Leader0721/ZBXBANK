...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "D:\\JavaProject\\weexpro\\src\\ui\\user\\other\\ui_credit_manage.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-2d596b0a"
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        handleScroll: function handleScroll(event) {
	            var scrolled = event.contentOffset.y;
	            cmObj.log("++++++++" + event.contentOffset.y);
	            this.offset = scrolled;
	            if (this.offset <= -300) {
	                this.isHide = 1;
	                console.log("this.offset <= -300");
	                //                    this.toHeight = (this.offset - 200)+"px";
	            } else {
	                this.isHide = 0;
	            }
	        },
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_vm._v("我靠")])]), _vm._l((_vm.arr), function(a) {
	    return _c('div', {
	      staticStyle: {
