...
import com.pub.http.HttpCallBackDownloadLS;
...
public abstract class BaseActivity extends AppCompatActivity implements ToolbarHelper.IToolBar {
     ...
     * @param httpCallBack
     */
    public void callRequest(Call call, HttpCallBackDownloadLS httpCallBack) {
        call.enqueue(httpCallBack);
        addRequest(call);
    }
    ...
    public void hideToolbar() {
        getToolbarHelper().setToolbarViewVisibility(View.GONE);
