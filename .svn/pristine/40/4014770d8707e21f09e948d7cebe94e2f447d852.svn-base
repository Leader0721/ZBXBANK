...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "D:\\JavaProject\\weexpro\\src\\ui\\mifi\\ui_mifi_updatelog.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-e12a3b68"
...
/***/ (function(module, exports) {
	...
	module.exports = {
	  "yellow-css": {
	    "backgroundColor": "#eeb611"
	  },
	  "red-css": {
	    "backgroundColor": "#ee376c"
	  },
	  "blue-css": {
	    "backgroundColor": "#51c6bf"
	  },
	  "headerBg": {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        this.screenWidth = config.env.deviceWidth;
	        this.navBarHeight = eventModule.getNavBarHeight();
	        ...
	        console.log("-----------------------" + eventModule.getNavBarHeight() + "++++" + config.env.platform);
	    },
	    methods: {
	        getColor: function getColor(i) {
	            var color = "yellow-css";
	            if (i % 3 == 1) {
	                color = "blue-css";
	            }
	            if (i % 3 == 2) {
	        ...
	        loadUrl: function loadUrl() {
	            ...
	            ntObj.postData(cmObj.UpdateLogGetList, body, this.successAct);
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  }, [_vm._v(_vm._s(_vm.title))])]), _c('list', {
	    staticClass: ["list"],
	    staticStyle: {
	      marginTop: "20px"
	    },
	    ...
	    }, [_vm._v(_vm._s(mod.Version))])])]), (i == _vm.lists.length - 1) ? _c('div', {
	    ...
	    }, [_vm._v(_vm._s(_vm.delHtmlTag(mod.Content)))])]) : _c('div', {
	      staticClass: ["cellRight"],
	      staticStyle: {
	        borderLeftWidth: "2px",
	    ...
	    }, [_vm._v(_vm._s(_vm.delHtmlTag(mod.Content)))])])])
	  }))])
	},staticRenderFns: []}
