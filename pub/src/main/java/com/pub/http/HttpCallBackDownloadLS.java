 ...
 */
public abstract class HttpCallBackDownloadLS<T> implements Callback {
     ...
     * @param context
     */
    public HttpCallBackDownloadLS(Class<T> clazz, Context context) {
     ...
     */
    public HttpCallBackDownloadLS(Class<T> clazz, Context context, String dir, String fileName, boolean isShowProgress) {
