...
public class ProgressLayout extends RelativeLayout {
    ...
    public void showEmpty() {
        //显示加载失败
        Drawable emptyImageDrawable = getResources().getDrawable(R.mipmap.loading_shuju);
        switchState(EMPTY, emptyImageDrawable, "暂时没有数据哦", "", null, null, Collections.<Integer>emptyList());
    }

    /**
     * Show empty view with a button when something goes wrong and prompting the user to try again
     *
     * @param onClickListener Listener of the error view button
     */
    public void showEmpty(OnClickListener onClickListener) {
        //显示加载失败
        Drawable errorDrawable = getResources().getDrawable(R.mipmap.loading_shuju);
        String errorTextTitle = "暂时没有数据哦";
        String errorTextContent = "";
        String errorButtonText = "刷新";
        switchState(ERROR, errorDrawable, errorTextTitle, errorTextContent, errorButtonText, onClickListener, Collections.<Integer>emptyList());
    }
...
//            loadingStateProgressBar = (ProgressBar) view.findViewById(R.id.loadingStateProgressBar);
    ...
    private void setErrorView() {
        if (errorStateRelativeLayout == null) {
            ...
            errorStateButton = (TextView) view.findViewById(R.id.errorStateButton);
