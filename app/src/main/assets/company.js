...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/7b3c30b019504bde12d70d17da8792f0', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/7b3c30b019504bde12d70d17da8792f0',undefined,undefined)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/smileline', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	          ...
	          "children": [
	            {
	              ...
	              "attr": {
	                "src": "assets/img/toolbar_back_white.png"
	              },
	              "events": {
	                "click": "backClick"
	              }
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "src": "assets/img/menu_creat_blog.png"
	              },
	              "events": {
	                "click": "createClick"
	              }
	                          ...
	                          "children": [
	                            {
	                              ...
	                              "attr": {
	                                "value": function () {return this.value.CompanyName.substring(0,1)}
	                              }
	                            }
	                          ]
	                        }
	                      ...
	                      "children": [
	                        {
	                          ...
	                          "attr": {
	                            "value": function () {return this.value.CompanyName}
	                          }
	                        },
	                        {
	                          "type": "div",
	                          ...
	                          "children": [
	                            {
	                              ...
	                              "attr": {
	                                "src": "assets/img/position_total.png"
	                              }
	                            },
	                            {
	                              "type": "text",
	                              ...
	                              "attr": {
	                                "value": function () {return this.value.UserCount}
	                              }
	                            },
	                            {
	                              "type": "text",
	                            ...
	                            },
	                            {
	                              ...
	                              "attr": {
	                                "src": "assets/img/bg_divider_1.png"
	                              }
	                            }
	                          ]
	                        }
...
/***/ (function(module, exports) {
	...
	module.exports = {
	  "btn": {
	    "backgroundColor": "#2b96da",
	    "color": "#FFFFFF",
	    "borderRadius": 90,
	    "overflow": "hidden",
	    "backgroundColor:active": "#FFFF00"
	  },
	  "item": {
	    "backgroundColor:active": "#f2f5fa"
	  }
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var cmObject = __webpack_require__(31);
	exports.default = (0, _defineProperty3.default)({
	    data: {
	        img_src: "toolbar_back_white.png",
	        Data: [{
	            UserCount: 1,
	            DepartmentCount: 0,
	            PositionCount: 0,
	            ...
	            UserPwn: null,
	            ID: "ce7bb26f-b98d-4223-b32e-2230fcf87fec",
	            CorprationNO: "1nb7pny",
	            CompanyName: "DB",
	            ShortName: null,
	            ComopanyDesc: null,
	            CompanyType: "其他",
	    ...
	    created: function created() {
	        ...
	        self.selectItemUrl = cmObj.local(bundleUrl, self.selectItemUrl);
	        self.sendRequest();
	        eventModule.callTest();

	        self.$on('refresh.onStart', function () {
	            page = 1;
	            self.sendRequest();
	            cmObj.log("refresh.onStart" + page);
	        });

	        self.$on('loading.onStart', function () {
	            page++;
	            self.sendRequest();
	    ...
	    methods: {
	        backClick: function backClick() {
	            this.$call('navigator', 'pop', { 'animated': 'true' }, function () {});
	            modal.toast({ message: '退回上一页', duration: 0.3 });
	        },
	        createClick: function createClick() {
	            modal.toast({ message: '新建公司', duration: 0.3 });
	        },
	        getCompanyList: function getCompanyList(repo, callback) {
	            return stream.fetch({
	                method: "post",
	                type: "json",
	                url: "http://proxy.dev.zbzbx.com/" + repo,
	                headers: {
	                    'TokenId': '49c7f77b-b29a-4c0c-b5d1-254e64254e87',
	    ...
	    this.getCompanyList('Organization/GetCompanyListByUserId', function (res) {
	        cmObject.log("this is res.data");
	        if (res.ok) {
	            cmObject.log(res.data.Data);
	            _this.Data = res.data.Data;

	            modal.toast({ message: '获取数据成功' + res.data.Data, duration: 0.3 });
	        } else {
	            modal.toast({ message: '获取数据失败', duration: 0.3 });
	        }
	    });
	});}
	/* generated by weex-loader */
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/pullrefresh', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	  ...
	  "children": [
	    {
	      ...
	      "shown": function () {return this.ifrefresh=='show'},
	      "children": [
	        {
	    ...
	    },
	    {
	      ...
	      "shown": function () {return this.ifloading=='show'},
	      "children": [
	        {
	          "type": "loading-indicator",
	          "classList": [
	...
	module.exports = {
	    ...
	    methods: {
	        onrefresh: function onrefresh(event) {
	            ...
	            self.$dispatch('refresh.onStart', self);
	        ...
	        onloading: function onloading(event) {
	            ...
	            self.$dispatch('loading.onStart', self);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.local = function (bundleUrl, fileName) {
	    if (fileName && bundleUrl) {
