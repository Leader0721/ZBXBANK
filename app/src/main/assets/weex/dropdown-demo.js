...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "D:\\JavaProject\\weexpro\\src\\dropdown-demo.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-e0a2ce4c"
	...
	exports.default = {
	    ...
	    data: function data() {
	        return {
	            screenHeight: 1000,
	            status: '0',
	            menudata: [{ id: '0', name: '全部' }, { id: '1', name: '待审核' }, { id: '2', name: '已通过' }, { id: '3', name: '已拒绝' }],
	            list: []
	        };
	    },
	    ...
	    methods: {
	        toast: function toast(params) {
	            mdMsg.showToast(params);
	        },
	        statuschange: function statuschange(detail) {
	            //            var detail = e.detail;
	            this.toast({
	        ...
	        filter: function filter() {
	            ...
	            if (state == '0') {
	                ...
	                this.list = allList.filter(function (item) {
	                    return item.questionStatus == state;
	                });
	            }
	        }
	    }
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    return _c('cell', {
	      ...
	      class: ['txt', 'status', 'status-' + (item.questionStatus)]
	    }, [_vm._v(_vm._s(item.questionStatusValue))]), _c('text', {
	      staticClass: ["txt"]
	    }, [_vm._v(", id: " + _vm._s(item.vid) + " ,")]), _c('text', {
	      staticClass: ["txt"]
	    }, [_vm._v("time: " + _vm._s(item.addTime))])])])
	  })) : _vm._e()])])], 1)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
