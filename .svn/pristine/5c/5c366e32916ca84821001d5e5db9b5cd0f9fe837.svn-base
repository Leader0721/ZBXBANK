...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "D:\\JavaProject\\weexpro\\src\\ui\\user\\mycompany\\ui_enterprise_detail.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-78238626"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        cmObj.log("this is test url");
	        cmObj.log(cmObj.getUrlObject());
	        this.CompanyId = cmObj.getUrlObject().CompanyId;
	        this.loadUrl();
	    },
	    methods: {
	        exitAct: function exitAct() {
	            var body = {};
	            body.CompanyId = this.CompanyId;
	            ntObj.postData(cmObj.ExitCompany, body, this.exitSuccessAct);
	        },
	        exitSuccessAct: function exitSuccessAct(info) {
	            cmObj.log(info);
	            if (info.Success == 1) {
	                show.showToast("退出成功");
	            } else {
	                show.showToast(info.Msg);
	            }
	        },
	        ...
	        loadUrl: function loadUrl() {
	            ...
	            ntObj.postData(cmObj.GetCompanyInfo, body, this.successAct);
	        },
	        successAct: function successAct(info) {
	            cmObj.log(info);
	            if (info.Success == 1) {
	                this.data = info.Data;
	            } else {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_vm._v(_vm._s(_vm.firstChar(_vm.data.CompanyName)))])]), _c('div', {
	    staticStyle: {
	      flex: "1",
	      alignItems: "center",
	      marginLeft: "20",
	  ...
	  }, [_vm._v(_vm._s(_vm.data.CompanyName))]), _c('text', {
	    staticStyle: {
	      fontSize: "32",
	      color: "#0088fb",
	      textAlign: "right",
	  ...
	  }, [_vm._v(_vm._s(_vm.data.UserCount))])]), _c('div', {
	    staticStyle: {
	  ...
	  }, [_vm._v(_vm._s(_vm.data.UserPermission))])]), _c('div', {
	    staticStyle: {
	      backgroundColor: "#DDDDDD",
	      height: "2"
	    }
	  ...
	  }, [_vm._v(_vm._s(_vm.data.CompanyType))])])])
	},staticRenderFns: []}
