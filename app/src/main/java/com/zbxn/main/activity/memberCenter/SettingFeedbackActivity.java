...
//        showAddButton();
    ...
    public void actionRight1(MenuItem menuItem) {
        ...
        if (lists.size() > 1) {
            uploadFile(SettingFeedbackActivity.this, lists);
        } else {
            submitData();
        }
        ...
        public void onCustomListener(int obj0, Object obj1, int position) {
            switch (obj0) {
                case 0://刪除
                    ...
                    lists = updatePhotos(lists, null);
                    PhotoListAdapter photoListAdapter = new PhotoListAdapter(SettingFeedbackActivity.this, lists, R.layout.list_item_select_photos, listener, true);
                ...
                case 3://显示大图
                    ...
                    Intent intent = new Intent(SettingFeedbackActivity.this, PhotoDetailActivity.class);
    ...
    private void pickImage() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN // Permission was added in API Level 16
            ...
            MultiImageSelector selector = MultiImageSelector.create(SettingFeedbackActivity.this);
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(R.string.mis_permission_dialog_ok, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(SettingFeedbackActivity.this, new String[]{permission}, requestCode);
                        }
                    })
