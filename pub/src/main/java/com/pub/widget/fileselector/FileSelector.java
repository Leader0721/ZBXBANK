...
import com.pub.R;
import com.pub.widget.fileselector.adapter.FileListAdapter;
import com.pub.widget.fileselector.config.FileConfig;
import com.pub.widget.fileselector.config.FileTheme;
import com.pub.widget.fileselector.utils.ColorUtils;
import com.pub.widget.fileselector.utils.FileFilter;
import com.pub.widget.fileselector.utils.FileType;
...
public class FileSelector {
    ...
    private void initAll() {
        ...
        hitBar = (RelativeLayout) fileSelector.findViewById(R.id.zhou_file_hit_bar);
    ...
    private void updateList(String path, int num) {
        ...
        try {
            ...
            if (num == 0) {
                ...
                Toast.makeText(context, "已是最上级", Toast.LENGTH_SHORT).show();
            }
            return;
        }
        files.clear();
